...
Ti.App.addEventListener('requestBibleQuote', function (e) {
    ...
    var bibleQuote = Alloy.createController("bibleQuote", { 
        version: bibles.selectedVersion, verse: e.verse 
    } );
    Alloy.Globals.navGroup.open(bibleQuote.getView());
});

// Make navigation group available globally and open the main window.
Alloy.Globals.navGroup = Alloy.createWidget("com.orthlieb.navigationgroup");
Alloy.Globals.navGroup.open($.getView(), { animated: true, transition: Ti.UI.iPhone.AnimationStyle.CURL_UP });
